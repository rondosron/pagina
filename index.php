					...
					<div class="accordion-item" data-aos="zoom-in" data-aos-once='true'>
						...
						<div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
							<div class="accordion-body">
								<strong>¡No!</strong> Solicitar un presupuesto es simplemente el primer paso para establecer una comunicación con la empresa. Luego, nos pondremos en contacto para ultimar los detalles del pedido (o de la consulta) y confirmar la transacción si así lo desea.
							</div>
						</div>
					</div>
					<div class="accordion-item" data-aos="zoom-in" data-aos-once='true'>
						...
						<div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingTwo">
							<div class="accordion-body">
								<strong>No.</strong> Los precios deberán ser confirmados por la empresa al momento de confirmar la compra.
							</div>
						</div>
					</div>
					<div class="accordion-item" data-aos="zoom-in" data-aos-once='true'>
